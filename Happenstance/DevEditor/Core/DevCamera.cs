    ...
    public class DevCamera : HSSyncScript
    {
        ...
        public override void OnStart()
        {
            ...
            else
            {
                ...
                var allCameraEntities = EntityFinder.FindEntitiesWithComponent<CameraComponent>();
        ...
        private void AlignSelectedEntityWithView()
        {
            ...
            // STRIDE WAY: Force update and get current world position for undo
            targetEntity.Transform.UpdateWorldMatrix();
            var oldWorldPosition = targetEntity.Transform.WorldMatrix.TranslationVector;
            var oldRotation = targetEntity.Transform.Rotation;

            // Get camera's world position
            Entity.Transform.UpdateWorldMatrix();
            var cameraWorldPos = Entity.Transform.WorldMatrix.TranslationVector;
        ...
        private void FocusOnSelectedEntity()
        {
            ...
            // STRIDE WAY: Force world matrix update and get world position
            ...
            // Look at the target using Stride's LookAt
            var lookAtMatrix = Matrix.LookAtRH(Entity.Transform.Position, targetPos, Vector3.UnitY);
            Entity.Transform.Rotation = Quaternion.RotationMatrix(Matrix.Invert(lookAtMatrix));
