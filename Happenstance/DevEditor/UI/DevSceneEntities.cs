...
namespace Happenstance.SE.DevEditor.UI
{
    public class DevSceneEntities : HSSyncScript
    {
        ...
        public override void OnStart()
        {
            ...
            _entityListCanvas = EntityFinder.GetUIElement<Canvas>(_uiPage, "entity_list_holder");
            ...
            _scrollViewer = EntityFinder.GetUIElement<ScrollViewer>(_entityListCanvas, "entity_scrollview");
            ...
            _entityStackPanel = EntityFinder.GetUIElement<StackPanel>(_scrollViewer, "entity_stackpanel");

            // Find other UI elements
            _filterInput = EntityFinder.GetUIElement<EditText>(_entityListCanvas, "filter_input");
            _refreshButton = EntityFinder.GetUIElement<Button>(_entityListCanvas, "refresh_button");
            _findButton = EntityFinder.GetUIElement<Button>(_entityListCanvas, "find_button");
            _selectedText = EntityFinder.GetUIElement<TextBlock>(_entityListCanvas, "selected_text");
