...
namespace Happenstance.SE.DevEditor.UI
{
    public class DevSceneInspector : HSSyncScript
    {
        ...
        public override void OnStart()
        {
            ...
            _scrollViewer = EntityFinder.GetUIElement<ScrollViewer>(_inspectorCanvas, "components_scroll");
            ...
            _inspectorCanvas = EntityFinder.GetUIElement<Canvas>(_uiPage, "entity_inspector_holder");
            ...
            _inspectorTitle = EntityFinder.GetUIElement<TextBlock>(_inspectorCanvas, "Entity Inspector");
            ...
            _componentsList = EntityFinder.GetUIElement<StackPanel>(_inspectorCanvas, "entity_stackpanel");
        ...
        {
            var element = EntityFinder.GetUIElement<T>(_inspectorCanvas, name);
            if (element == null)
            {
        ...
        private void UpdateInspectorUI(Entity entity)
        {
            ...
            Vector3 rotation = _editorManager.GetEulerAnglesFromQuaternion(entity.Transform.Rotation);
        ...
        private void AdjustRotationX(float delta)
        {
            ...
            Vector3 euler = _editorManager.GetEulerAnglesFromQuaternion(_editorManager.SelectedEntity.Transform.Rotation);
